...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lists_image', 'name', self.gf('django.db.models.fields.CharField')(default='no name', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.name'
        db.delete_column('lists_image', 'name')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'dpeibqas'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'8qdxiz8l'", 'max_length': '8'}),
