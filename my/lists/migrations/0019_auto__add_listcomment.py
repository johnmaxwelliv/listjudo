...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lists_listcomment', (
            ('ugc_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lists.UGC'], unique=True, primary_key=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.Entry'])),
        ))
        db.send_create_signal('lists', ['ListComment'])


    def backwards(self, orm):
        
        # Deleting model 'ListComment'
        db.delete_table('lists_listcomment')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'95kwlex5'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'hkvwsrif'", 'max_length': '8'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'lists.listcomment': {
            ...
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.Entry']"}),
            'ugc_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['lists.UGC']", 'unique': 'True', 'primary_key': 'True'})
        },
        'lists.ugc': {
