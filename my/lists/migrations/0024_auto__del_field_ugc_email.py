...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UGC.email'
        db.delete_column('lists_ugc', 'email')


    def backwards(self, orm):
        
        # Adding field 'UGC.email'
        db.add_column('lists_ugc', 'email', self.gf('django.db.models.fields.EmailField')(default='unknown@example.com', max_length=75), keep_default=False)
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'kbquw97a'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'glzizfir'", 'max_length': '8'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'lists.ugc': {
            ...
            'nickname': ('django.db.models.fields.CharField', [], {'default': "'Anonymous'", 'max_length': '20'}),
