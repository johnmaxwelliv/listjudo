...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lists_entryimage', (
        ...
        db.send_create_signal('lists', ['EntryImage'])

        # Changing field 'Entry.image'
        db.alter_column('lists_entry', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.EntryImage'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lists_entryimage')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'cq46a45x'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'oo9c5sdj'", 'max_length': '8'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
