...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAction.created'
        db.alter_column('lists_useraction', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'UserAction.modified'
        db.alter_column('lists_useraction', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'UserAction.created'
        db.alter_column('lists_useraction', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True))

        # Changing field 'UserAction.modified'
        db.alter_column('lists_useraction', 'modified', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True))
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'e4qvpni6'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'j8bqkxju'", 'max_length': '8'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
