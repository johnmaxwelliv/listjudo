...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.image'
        db.add_column('lists_list', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.EntryImage'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.image'
        db.delete_column('lists_list', 'image_id')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'qwrk89v8'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'0ohglvzu'", 'max_length': '8'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.EntryImage']", 'null': 'True', 'blank': 'True'}),
