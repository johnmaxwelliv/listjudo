...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.oembed'
        db.alter_column('lists_entry', 'oembed', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Entry.oembed'
        db.alter_column('lists_entry', 'oembed', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'uwffly8w'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'hz2t8drn'", 'max_length': '8'}),
