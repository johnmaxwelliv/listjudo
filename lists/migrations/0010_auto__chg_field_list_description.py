...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lists_list', 'description', self.gf('django.db.models.fields.TextField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'List.description'
        db.alter_column('lists_list', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'lists.list': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'default': "'5c2bhlvz'", 'max_length': '8'}),
            'admin_code': ('django.db.models.fields.CharField', [], {'default': "'nikufps5'", 'max_length': '8'}),
