...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'List.views'
        db.alter_column('lists_list', 'views', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'List.views'
        db.alter_column('lists_list', 'views', self.gf('django.db.models.fields.IntegerField')())
